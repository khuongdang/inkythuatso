(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		_init 				: function( options ) {
			...
			// <ul>
			this.$slider		= this.$el.find('ul.items');
